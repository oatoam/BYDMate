...
public class AutoStatisticDeviceHelper {

    private static AutoStatisticDeviceHelper INSTANCE;
    ...
    private AutoStatisticDeviceHelper(BYDAutoStatisticDevice device) {
        this.device = device;
    }

    public static AutoStatisticDeviceHelper getInstance(BYDAutoStatisticDevice device) {
        if (INSTANCE == null) {
            INSTANCE = new AutoStatisticDeviceHelper(device);
        }
        return INSTANCE;
    }
